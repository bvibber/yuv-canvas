var YCBCR_VERTEX_SHADER = readFileSync('./YCbCr.vsh');
var YCBCR_FRAGMENT_SHADER = readFileSync('./YCbCr.fsh');
var YCBCR_STRIPE_FRAGMENT_SHADER = require('./YCbCr-stripe.fsh');
